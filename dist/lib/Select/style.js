...
const SelectedStyle = cva([
    'inline-flex w-full gap-2 items-center font-medium justify-between ring-1 ring-gray-300/70 bg-gray-50 text-gray-700 hover:bg-gray-100 disabled:ring-gray-300 disabled:bg-gray-200 disabled:text-gray-400',
], {
    variants: {
        size: {
...
const ListStyle = cva([
    'absolute z-10 w-full rounded-lg text-base text-gray-700 font-medium bg-white border shadow-border max-h-[300px] overflow-auto',
], {
    variants: {
        direction: {
