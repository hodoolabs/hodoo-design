...
const CheckBox = ({ checked, label, helper, disabled = false, onChange }) => {
    return (_jsxs("div", { className: 'inline-flex gap-3', children: [_jsx("button", { className: cn(CheckBoxStyle({ checked })), disabled: disabled, onClick: () => onChange(!checked), children: checked && (disabled ? _jsx(CheckedDisabledSvg, {}) : _jsx(CheckedSvg, {})) }), label && (_jsxs("div", { className: 'flex flex-col gap-1', children: [_jsx("label", { className: cn(LabelStyle({ disabled })), onClick: () => !disabled && onChange(!checked), children: label }), helper && _jsx("p", { className: cn(HelperStyle({ disabled })), children: helper })] }))] }));
};
