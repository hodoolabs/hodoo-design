...
const Illustrations = ({ type = 'noResults', description, className }) => {
    return (_jsx("div", { className: `flex items-center justify-center w-full h-full ${className}`, children: _jsxs("div", { className: 'flex flex-col items-center gap-4', children: [type === 'list' && _jsx(ListSvg, {}), type === 'noResults' && _jsx(NoResultsSvg, {}), _jsx("div", { className: 'text-base font-medium text-center text-gray-500 whitespace-pre-line', children: description })] }) }));
};
