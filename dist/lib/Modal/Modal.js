...
const Modal = ({ modalState, modalHistory, goBackModal, closeModal, isMobile = false, animationBottomToTop, }) => {
    ...
    return (_jsxs("div", { className: ModalContainerStyle({ isMobile, animationBottomToTop }), children: [_jsxs("div", { className: cn(ModalStyle({ size: modalState.size })), children: [_jsx(Header, { modalState: modalState, modalHistory: modalHistory, goBackModal: goBackModal, closeModal: closeModal }), _jsx("div", { className: cn(ModalContentStyle({ isMobile })), children: modalState.content })] }), _jsx("div", { className: 'absolute top-0 left-0 z-40 w-full h-full bg-black/70', onClick: closeModal })] }));
};
