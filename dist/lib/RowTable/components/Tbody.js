...
const Tbody = ({ columns, checkBox, sortDatas }) => {
    ...
    return (_jsx("tbody", { children: sortDatas === null || sortDatas === void 0 ? void 0 : sortDatas.map((record, index) => (_jsxs("tr", { className: 'flex items-center font-medium border-b border-solid border-b-gray-200 hover:bg-gray-50', children: [checkBox && (_jsx("td", { className: 'p-4 leading-none', children: _jsx(CheckBox, { checked: selected.map((item) => item[id]).includes(record[id]), onChange: () => {
