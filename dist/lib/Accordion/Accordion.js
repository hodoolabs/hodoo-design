...
const Accordion = ({ list, onPush, pathname }) => {
...
export default memo(Accordion, (prev, next) => prev.list === next.list && prev.onPush === next.onPush && prev.pathname === next.pathname);
