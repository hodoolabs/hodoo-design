...
declare const _default: import("react").MemoExoticComponent<({ label, isSingleCalendar, value, error, helper, required, className, onChange, onError, ...props }: DatePickerProps) => import("react/jsx-runtime").JSX.Element>;
