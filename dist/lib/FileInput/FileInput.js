...
const FileInput = ({ size = 'lg', value, buttonName, label, error, placeholder, helper, required, multiple = false, disabled = false, className, onChange, }) => {
