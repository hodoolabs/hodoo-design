...
const ToogleBoxStyle = cva(
	...
	],
	{
		variants: {
			size: {
				sm: [
					'w-9 h-5 after:left-0.5 after:top-0.5 after:h-4 after:w-4 after:scale-90 peer-checked:after:translate-x-4',
				],
				md: ['w-11 h-6 after:left-1 after:top-1 after:h-4 after:w-4 after:scale-110 peer-checked:after:translate-x-5'],
...
const HelperStyle = cva(['text-sm font-medium text-gray-500 cursor-pointer'], {
	variants: {
		disabled: {
			true: ['text-gray-400 cursor-default'],
		},
